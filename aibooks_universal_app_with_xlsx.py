...
st.write("Upload your QuickBooks Bank Register and Bank Statement (CSV, XLSX, or PDF). AIBooks will extract date, description, debit, credit, and calculate net amounts to detect mismatches.")
...
register_file = st.file_uploader("Upload Bank Register (CSV, XLSX, or PDF)", type=["csv", "xlsx", "pdf"])
statement_file = st.file_uploader("Upload Bank Statement (CSV, XLSX, or PDF)", type=["csv", "xlsx", "pdf"])
